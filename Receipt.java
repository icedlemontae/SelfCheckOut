...
public class Receipt extends javax.swing.JFrame {
    ...
    public Receipt(String custID, String custIC, String custName, double totalAmount, double paidAmount, double balance, Queue listItem) {
        ...
        totalAmountlabel.setText("Total: RM " + totalAmount + "0");
        paidlabel.setText("Paid: RM " + paidAmount + "0");
        balancelabel.setText("Balance: RM " + balance + "0");

        //DISPLAY ITEM TO TABLE
        DefaultTableModel receiptTableModel = (DefaultTableModel) itemReceiptTable.getModel();
        for (Iterator itr = listItem.iterator(); itr.hasNext();) {
            CustomerInformation customeritemdata = (CustomerInformation) itr.next();
